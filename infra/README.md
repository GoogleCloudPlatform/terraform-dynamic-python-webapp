...
|------|-------------|------|---------|:--------:|
| client\_image\_host | Artifact Registry that hosts the client image (PROJECT_ID/registry) | `string` | `"hsa-public/containers/terraform-python-dynamic-webapp"` | no |
...
| server\_image\_host | Artifact Registry that hosts the server image (PROJECT_ID/registry) | `"hsa-public/containers/terraform-python-dynamic-webapp"` | no |
