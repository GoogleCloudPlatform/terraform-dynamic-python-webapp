...
|------|-------------|------|---------|:--------:|
| client\_image\_host | Artifact Registry that hosts the client image (PROJECT\_ID/registry[/folder]) | `string` | `"hsa-public/containers/terraform-python-dynamic-webapp"` | no |
...
| server\_image\_host | Artifact Registry that hosts the server image (PROJECT\_ID/registry[/folder]) | `string` | `"hsa-public/containers/terraform-python-dynamic-webapp"` | no |
